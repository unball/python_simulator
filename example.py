...
game_duration = 200 # Use it to bound the maximum time during a one_game_duration
                    # IMPORTANT: FPS doesn't mean a simulation more faster, just a more
                    # precise transition betwen the frames!!!!!
                    # To improve the time siluation find a method to improve the MAIN LOOP bellow!!!

# Field is the enviroment and into there you'll find all necessary methods as reset, step, render and close.
env = Field(num_allies=5, num_opponents=5, team_color='blue', allied_field_side='left', render=True)
